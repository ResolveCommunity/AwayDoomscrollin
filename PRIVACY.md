...
- **What it does:** It monitors the active window content locally to recognize short-video UI elements. If detected, it intervenes to stop the scrolling loop.
- **What it does NOT do:** It does NOT read your messages, comments, passwords, or personal data. It does NOT record your screen.

## 3. Data Collection and Telemetry
The core blocking functionality of AwayDoomscrollin' operates **100% offline**.
