...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const i18n = {
        en: {
            ...
            legal_p3_text3: "AwayDoomscrollin' NEVER reads, inspects, logs, or stores text inputs, keystrokes, passwords, credit card information, private messages (DMs), contact lists, photos, or browsing history. Accessibility data is evaluated strictly in real-time in RAM and discarded immediately.",
            legal_p4_title: "4. Local Data Storage & Preferences",
            legal_p4_text: "All statistics, including total blocked counts, daily streak counters, selected target app toggles, and recent shield activity logs, are saved exclusively in your device's local memory via SharedPreferences ('away_doomscroll_prefs'). This data remains strictly on your physical device and is automatically removed upon uninstalling the App.",
        ...
        tr: {
            ...
            legal_p3_text3: "AwayDoomscrollin' KESİNLİKLE metin girdilerinizi, klavye basışlarınızı, şifrelerinizi, kredi kartı bilgilerinizi, özel mesajlarınızı (DM), rehberinizi, fotoğraflarınızı veya tarama geçmişinizi okumaz, incelemez, kaydetmez veya saklamaz. Erişilebilirlik verileri yalnızca anlık olarak RAM'de değerlendirilir ve derhal imha edilir.",
            legal_p4_title: "4. Yerel Veri Depolama ve Tercihler",
            legal_p4_text: "Toplam engelleme sayıları, günlük seri (streak) sayaçları, seçilen hedef uygulama toggle düğmeleri ve canlı kalkan günlükleri dahil tüm istatistikler yalnızca cihazınızın yerel belleğinde SharedPreferences ('away_doomscroll_prefs') aracılığıyla saklanır. Bu veriler kesinlikle fiziksel cihazınızda kalır ve Uygulamayı kaldırdığınızda otomatik olarak silinir.",
