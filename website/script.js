...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const i18n = {
        en: {
            ...
            faq_a1: "Privacy First. Screen-content analysis and blocking run locally. Anonymous telemetry is enabled by default and can be disabled in the app; while enabled it sends the disclosed device/app fields and aggregate blocking statistics to awaydoomscrollin.com. GitHub rule updates run automatically and independently of the telemetry switch. Accessibility permission is used to detect target screens and scrolling gestures.",
            ...
            legal_last_updated: "Last Updated: August 1, 2026",

            legal_p1_title: "1. Introduction & Transparency Commitment",
            legal_p1_text: "At AwayDoomscrollin', we believe digital well-being tools should disclose their behavior clearly. This Privacy Policy explains how the App handles accessibility data, local storage, default-on anonymous telemetry, and automatic GitHub rule updates. We do not sell personal information or use third-party advertising analytics.",
            legal_p2_title: "2. Network Data Collection",
            legal_p2_text: "Screen-content analysis and blocking run on-device. Anonymous telemetry is enabled by default and can be disabled in the App. While enabled, it sends device manufacturer/model, Android and SDK version, app version, aggregate platform/total block counts, streak days, and XP to awaydoomscrollin.com. Separately, the App automatically contacts GitHub at app or accessibility-service startup for rule/configuration updates; successful fetches are cached for six hours and are not controlled by the telemetry switch. Screen contents, messages, passwords, and location are not transmitted.",
            ...
            legal_p4_text: "Blocking statistics, streak counters, target-app toggles, and recent shield activity are stored locally via SharedPreferences ('away_doomscroll_prefs') and are removed when the App is uninstalled. While telemetry is enabled, the disclosed aggregate block, streak, and XP fields are also submitted to awaydoomscrollin.com.",
        ...
        tr: {
            ...
            faq_a1: "Gizlilik odaklıdır. Ekran içeriği analizi ve engelleme cihazda çalışır. Anonim telemetri varsayılan açıktır ve uygulamadan kapatılabilir; açıkken açıklanan cihaz/uygulama alanları ile toplu engelleme istatistiklerini awaydoomscrollin.com'a gönderir. GitHub kural güncellemeleri telemetri anahtarından bağımsız ve otomatik çalışır. Erişilebilirlik izni hedef ekranları ve kaydırma hareketlerini algılamak için kullanılır.",
            ...
            legal_last_updated: "Son Güncelleme: 1 Ağustos 2026",

            legal_p1_title: "1. Giriş ve Şeffaflık Taahhüdü",
            legal_p1_text: "AwayDoomscrollin' olarak dijital refah araçlarının davranışlarını açıkça anlatması gerektiğine inanıyoruz. Bu Gizlilik Politikası erişilebilirlik verilerini, yerel depolamayı, varsayılan açık anonim telemetriyi ve otomatik GitHub kural güncellemelerini açıklar. Kişisel bilgileri satmayız ve üçüncü taraf reklam analitiği kullanmayız.",
            legal_p2_title: "2. Ağ Üzerinden Veri İşleme",
            legal_p2_text: "Ekran içeriği analizi ve engelleme cihaz üzerinde çalışır. Anonim telemetri varsayılan açıktır ve uygulamadan kapatılabilir. Açıkken cihaz üreticisi/modeli, Android ve SDK sürümü, uygulama sürümü, platform/toplam engelleme sayıları, seri günleri ve XP awaydoomscrollin.com'a gönderilir. Uygulama ayrıca uygulama veya erişilebilirlik servisi başladığında kural/yapılandırma güncellemeleri için GitHub'a otomatik bağlanır; başarılı indirmeler altı saat önbelleğe alınır ve telemetri anahtarından bağımsızdır. Ekran içeriği, mesajlar, şifreler ve konum aktarılmaz.",
