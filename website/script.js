...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const i18n = {
        en: {
            ...
            legal_p2_text: "Screen-content analysis runs on-device. Pseudonymous telemetry is disabled by default and nothing is sent to awaydoomscrollin.com unless the user explicitly opts in. While enabled, the disclosed installation, device/app, and aggregate statistics are sent; the latest server snapshot expires within 90 days. Separately, the App automatically requests GitHub rule/configuration data at app or accessibility-service startup and caches successful results for six hours. Turning telemetry off does not disable GitHub requests, and there is currently no separate opt-out. Screen contents, messages, passwords, and location are not transmitted.",
        ...
        tr: {
            ...
            legal_p2_text: "Ekran içeriği analizi cihazda çalışır. Takma adlı telemetri varsayılan kapalıdır ve kullanıcı açıkça etkinleştirmedikçe awaydoomscrollin.com'a veri gönderilmez. Açıkken açıklanan kurulum, cihaz/uygulama ve toplu istatistik alanları gönderilir; son sunucu kaydı en geç 90 gün içinde silinir. Bundan ayrı olarak uygulama veya erişilebilirlik servisi başladığında GitHub kural/yapılandırma verisi otomatik istenir ve başarılı sonuçlar altı saat önbelleğe alınır. Telemetriyi kapatmak GitHub isteklerini kapatmaz ve şu anda ayrı bir kapatma seçeneği yoktur. Ekran içeriği, mesajlar, şifreler ve konum aktarılmaz.",
